...
TARGET_PROGRAM_MAJOR_CODE_MAP: dict[str, str] = {
    ...
    "ALLIED_HEALTH": "HEALTH_SCIENCES_MEDICINE",
    "HUMANITIES_SOCIAL_SCIENCES": "PSYCHOLOGY",
    "MEDICINE_DENTISTRY": "HEALTH_SCIENCES_MEDICINE",
    "BUSINESS_MANAGEMENT": "BUSINESS_ADMINISTRATION",
    "MEDICAL_SCIENCES": "HEALTH_SCIENCES_MEDICINE",
    "NURSING_MIDWIFERY": "HEALTH_SCIENCES_MEDICINE",
    "ENGINEERING_TECHNOLOGY": "ENGINEERING",
    "LAW_LEGAL_STUDIES": "LAW",
    # Legacy aliases after Health Sciences & Medicine was restored as a catalog major.
    "MEDICINE": "HEALTH_SCIENCES_MEDICINE",
}
