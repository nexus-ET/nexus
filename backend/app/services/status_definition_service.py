...
# Canonical stage IDs (status_definitions v3 — 45 stages)
STATUS_LEAD_NEW = 1
...
STATUS_LEAD_MARKETING_ENABLED = 10
STATUS_LEAD_MARKETING_DISABLED = 11
STATUS_COUNSELLING_SCHEDULED = 12
STATUS_COUNSELLING_FINISHED = 13
STATUS_COUNSELLING_FOLLOW_UP = 15
STATUS_COUNSELLING_PROSPECT_QUALIFIED = 14
STATUS_COUNSELLING_CANCELLED = 16
STATUS_COUNSELLING_DEFERRED = 17
STATUS_DOCUMENT_IN_PREPARATION = 18
STATUS_ADMISSION_DOC_PREP = STATUS_DOCUMENT_IN_PREPARATION
STATUS_VISA_DOC_PREP = 28
STATUS_PROSPECT_ENROLLED = 43
STATUS_PROSPECT_CANCELLED = 44
STATUS_PROSPECT_RELAUNCH = 45
...
STAGE_DOCUMENT_IN_PREPARATION = "Document: In Preparation"

TERMINAL_STATUS_IDS = frozenset({7, 8, 9, 16, 17, 27, 35, 43, 44})

LEGACY_ADMISSION_STAGE_MAP: dict[str, int] = {
    "COUNSELLING": STATUS_COUNSELLING_SCHEDULED,
    "AWAITING_DOCS": STATUS_DOCUMENT_IN_PREPARATION,
    "APPLIED": 23,
    "UNDER_REVIEW": 24,
    "OFFERED": 26,
